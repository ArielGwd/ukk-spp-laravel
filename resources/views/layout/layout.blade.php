...
<head>
    ...
    <title>SPP Administration</title>
...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; App Pembayaran SPP </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" href="{{ url('/logout/siswa') }}">Logout</a>
                    @endif
                    @if (Str::length(Auth::guard('admin')->user()) > 0)
                    <a class="btn btn-danger" href="{{ url('/logout/petugas') }}">Logout</a>
                    @endif
                </div>
            </div>
        </div>
    ...
    {{-- myJavaScript --}}
    <script src="{{ asset('assets/template/js/myJs/index.js') }}"></script>
